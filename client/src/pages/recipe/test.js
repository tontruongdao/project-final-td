export const test = 
  {
      ...
      "extendedIngredients": [
        ...
        },
        {
          ...
          "consistency": "solid",
          "name": "flour",
          "original": "*Substitute 2 cups all-purpose flour + 1 teaspoon baking powder + ½ teaspoon salt and increase the water to ½ cup",
          "originalString": "*Substitute 2 cups all-purpose flour + 1 teaspoon baking powder + ½ teaspoon salt and increase the water to ½ cup",
          "originalName": "Substitute 2 cups all-purpose flour + 1 teaspoon baking powder + ½ teaspoon salt and increase the water to",
          "amount": 0.5,
          "unit": "cup",
          "meta": [
            "all-purpose"
      ...
      "analyzedInstructions": [
        {
          ...
          "steps": [
            {
              "number": 1,
              "step": "Preheat oven to 425°F and lightly grease two 12\" round pizza pans, or a couple of large baking sheets.",
              "ingredients": [],
              "equipment": [
                {
                  "id": 404727,
            ...
            {
              "number": 2,
              "step": "Mix the flour, oil, and water together - the mixture will be shaggy. Use your hands to gather it together and form into a ball. Divide it in two and form each half into a disk the rounder the better.",
              "ingredients": [
                {
                  "id": 20081,
            ...
            {
              "number": 3,
              "step": "Cover with saran wrap and allow to rest 10 minutes to make for easier rolling - skip this step if you're in a hurry.",
              "ingredients": [
                {
                  "id": 10018364,
                  "name": "wrap",
            ...
            {
              "number": 4,
              "step": "Grease a piece of parchment or wax paper about 12\" square and set a circle of dough in the middle. Cover with another lightly greased piece. Use a rolling pin to roll the dough very thin - ⅛ inch or less.",
              "ingredients": [
                {
                  "id": 0,
                  "name": "dough",
            ...
            {
              "number": 6,
              "step": "Mix the cheeses together and sprinkle ½ over top of each then season with Italian herbs or pizza seasoning.",
              "ingredients": [
                {
                  "id": 1052027,
                  "name": "pizza seasoning",
                  "localizedName": "pizza seasoning",
                  "image": "seasoning.png"
                },
                {
                  "id": 1022027,
            ...
            {
              "number": 7,
              "step": "Bake the pizzas for 9 to 12 minutes or until the cheese is melted with a few golden brown spots and the edges/bottom of the crust are golden brown.",
              "ingredients": [
                {
                  "id": 1041009,
                  "name": "cheese",
...
export const steps = test.analyzedInstructions[0].steps